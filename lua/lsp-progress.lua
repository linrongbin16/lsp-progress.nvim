...
function CLIENTS:hasClient(client_id)
    return self[client_id] ~= nil
end

function CLIENTS:getClient(client_id)
    return self[client_id]
end

function CLIENTS:removeClient(client_id)
    self[client_id] = nil
end

function CLIENTS:registerClient(client_id, client_name)
